...
raw_df = pd.read_csv('./dataset/stock_data_china_paper.csv')
...
plt.tight_layout()
plt.savefig('result/hs300/top200/four_methods_comparison.png', dpi=150)
...
plt.tight_layout()
plt.savefig('result/hs300/top200/all_methods_clustering.png', dpi=150)
...
plt.savefig('result/hs300/top200/all_methods_heatmap.png', dpi=150)
...
plt.tight_layout()
plt.savefig('result/hs300/top200/all_methods_piecharts.png', dpi=150)
